...
import net.corda.training.state.NodeInfoShare
import net.corda.training.state.NodeInfoShareState


@InitiatingFlow
@StartableByRPC
class NodeInfoShareFlow(val target: Party,
                        val message: String,
                        val test: String) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
        ...
        val nodeInfo =  NodeInfoShare(message,test)
        val state = NodeInfoShareState(me, target, nodeInfo)
